...
let 哎呀呀这是我的VL密钥 = "a0ad9f9b-d7b5-466e-a62b-ebe69d85ede9"; //建议修改为自己的规范化UUID
...
let 自定义路径 = '/proxyip=sjc.o00o.ooo' //我的脚本已经抛弃了ed头，这个功能是给想兼容其他纯传输脚本的同学研究的，示例：'/?proxyip=111.111.111.111'
//////////////////////////////////////////////////////////////////////////网页入口////////////////////////////////////////////////////////////////////////
export default {
  async fetch(访问请求) {
